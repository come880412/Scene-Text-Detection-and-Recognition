...
def get_args(is_train=True):
    ...
    parser.add_argument('--data_dir', default='../../dataset/train/train_crop', help='path to training dataset')
    parser.add_argument('--character_dir', default='../../dataset/train/character.txt', help='path to character list')
    parser.add_argument('--train_data', default='../../dataset/train/train.json', help='path to training json')
    parser.add_argument('--valid_data', default='../../dataset/train/val.json', help='path to validation json')
    ...
    parser.add_argument('--saved_model', default='vitstr_base_patch16_224_aug.pth', help="path to model to continue training")
