...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/yolov5l_class.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='./data/class.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='expl', help='save to project/name')
